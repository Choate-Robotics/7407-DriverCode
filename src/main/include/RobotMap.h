...
namespace motor{
extern frc::PWMTalonSRX * motor::frontLeft;
extern frc::PWMTalonSRX * motor::frontRight;
extern frc::PWMTalonSRX * motor::backLeft;
extern frc::PWMTalonSRX * motor::backRight;
